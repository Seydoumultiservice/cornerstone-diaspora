      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="section-subtitle">
            {language === 'fr' 
              ? 'Décrivez votre projet et téléchargez les documents pertinents pour recevoir une estimation sur mesure.'
              : 'Describe your project and upload relevant documents to receive a custom estimation.'}
          </p>
        </div>
        ...
        <Card className="max-w-2xl mx-auto shadow-lg">
          <CardHeader className="bg-cornerstone-red text-cornerstone-white rounded-t-lg">
            <CardTitle>
              {language === 'fr' ? 'Demande d\'estimation' : 'Request Estimation'}
            </CardTitle>
